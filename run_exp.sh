...
rm -rf log_dir
mkdir log_dir
MARK_STEP_BEFORE_OPT=True PYTHONBREAKPOINT=0 PROFILE_EPOCH=0 PROFILE_STEP=5 PROFILE_DURATION_MS=50000 PROFILE_LOGDIR="/tmp/${exp_name}/" python /llama8b_trainer.py
bash /post_exp.sh $exp_name $log_dir

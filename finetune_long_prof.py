...
class ScriptArguments:
    ...
    model_name: Optional[str] = field(
        default="meta-llama/Meta-Llama-3-8B-Instruct", #meta-llama/Meta-Llama-3-8B-Instruct
        metadata={
...
if __name__ == "__main__":
    ...
    # duration_ms = 1000*60*5# 20minutes
    # delay_ms = 1000*60*18
    # server = xp.start_server(profile_port) # starts server, waiting to start tracing
    # xp.trace_detached(f'localhost:{profile_port}',profile_logdir, duration_ms=duration_ms, delay_ms =delay_ms ) #starts tracing

...
def trace_handler(p):
    ...
    output_dir = os.path.join(profile_logdir, "trace_" + str(p.step_num) + ".json")
    print(f"saving python trace to {output_dir}")
    p.export_chrome_trace(output_dir)
